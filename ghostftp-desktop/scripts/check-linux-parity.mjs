...
expect('RC23 native build includes AppImage', matches('../.github/workflows/ghostftp-build-rc23.yml', /--bundles deb,rpm,appimage/));
expect('RC23 native build uploads Linux desktop artifact', contains('../.github/workflows/ghostftp-build-rc23.yml', 'GhostFTP-Linux-x86_64-RC23'));
