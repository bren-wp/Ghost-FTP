...
This document describes what is implemented in the current Ghost FTP 2.1.1 RC21 source. It is intentionally separated from future ideas so the repository does not present planned work as finished functionality.
...
RC21 retains the single-window architecture and further hardens:
