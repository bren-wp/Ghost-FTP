...
ByFTP 1.2.0 adds a native SwiftUI application for iOS 16+ on arm64 iPhone/iPad devices. Official release evidence contains:
...
The first iOS transport supports FTP and implicit FTPS. Explicit FTPS and SFTP remain intentionally unavailable on iOS until separately audited native implementations exist.
