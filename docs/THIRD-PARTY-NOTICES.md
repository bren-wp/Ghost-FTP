...
Ghost FTP is built with Go and uses operating-system facilities plus command-line networking tools where appropriate. Windows SFTP can rely on the Windows OpenSSH Client feature. Unix FTP/FTPS uses system `curl`; Unix SFTP uses OpenSSH tooling.
