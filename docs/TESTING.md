...
Android has an independent CI job so mobile build failures cannot hide inside desktop tests. The gate provisions JDK 17 and Gradle 9.5.0, installs Android platform 37/build-tools 36.0.0, then runs:
