...
Ghost FTP **0.0.6** is the current supported public release.
...
2. Confirm the file came from the canonical `ghostftp-v0.0.6` release when reporting a public Windows/Linux/Android/browser package issue.
