...
class MaintenanceRegressionTests(unittest.TestCase):
    ...
    def test_platform_contract_rejects_only_retired_target_reintroduction(self) -> None:
        ...
        self.assertIn("ANDROID_PUBLIC_RELEASE_ARTIFACT=YES_COMPATIBILITY_OR_PRODUCTION_SIGNED", audit)
        ...
        self.assertIn("MACOS_PUBLIC_RELEASE_ARTIFACT=YES_ADHOC_COMPATIBILITY", audit)
    ...
    def test_current_release_has_explicit_no_key_compatibility_signing(self) -> None:
        workflow = read(".github/workflows/release.yml")
