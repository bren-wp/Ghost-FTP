...
class FileFilterUIContractTests(unittest.TestCase):
    ...
    def test_linux_render_selection_and_refresh_use_visible_slice(self) -> None:
        ...
        self.assertIn("func (u *linuxDesktop) handleLinuxFileSortHeaderMouse", sort_source)
        self.assertIn("u.linuxFileHeaderField(remote, x)", sort_source)
        self.assertIn("u.setLinuxFileSortField(remote, field)", sort_source)
        self.assertIn("itemlist.FieldPermissions", sort_source)
