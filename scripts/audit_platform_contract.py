...
RETIRED_ROOTS = ("ios/", "GhostFTP WEB/", "web/")
RETIRED_SCRIPTS = {
...
BROWSER_REQUIRED = {
    ...
    "cmd/ghostftp-native-host/main.go",
    "scripts/build_browser_extensions.py",
    "scripts/build_browser_bridge_binaries.py",
    "scripts/build_native_host_manifests.py",
...
def main() -> int:
    ...
    for retired in (
        ...
        if (ROOT / retired).exists():
            fail(f"retired web surface must remain absent: {retired}")
    ...
    print("ACTIVE_SOURCE_PLATFORMS=WINDOWS,LINUX,ANDROID,MACOS,BROWSER_HELPER")
    ...
    print("BROWSER_NATIVE_MESSAGING_BRIDGE=LOCAL_ENGINE")
