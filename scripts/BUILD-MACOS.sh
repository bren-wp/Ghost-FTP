...
echo "ByFTP ${VERSION} macOS package built successfully with ${raw_go}; telemetry=${telemetry}."
echo 'Note: the package remains unsigned until a real Apple Developer ID certificate is available.'
