...
# Ghost FTP remains the only public product brand. Brendigo LTD may appear where
# it is legally or historically necessary to identify the copyright owner,
# publisher, support destination or project provenance. Runtime product surfaces
# remain blocked except the maintained About identity sources.
