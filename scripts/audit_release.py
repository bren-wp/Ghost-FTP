...
def main() -> int:
    ...
    for marker in (
        ...
        "ByFTP-$env:VERSION-Android-debug.apk",
        "ByFTP-$env:VERSION-Android-release-unsigned.apk",
    ...
    print("RELEASE_MATRIX=WINDOWS_X64_X86,LINUX_AMD64_ARM64_I386,MACOS_UNIVERSAL,ANDROID_DEBUG_AND_UNSIGNED_RELEASE_APK")
