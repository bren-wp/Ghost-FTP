...
The extension **does not launch the desktop client directly** and does not launch the Android app. Ghost FTP currently exposes no supported browser-to-app native-messaging or custom-URI handoff. The browser package therefore remains a local parser/copy companion instead of inventing a privileged bridge.
