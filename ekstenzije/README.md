...
The extension does **not** launch the desktop/mobile client. Ghost FTP currently exposes no supported browser-to-app native-messaging or custom-URI handoff. The browser package therefore remains a local parser/copy companion instead of inventing a privileged bridge.
