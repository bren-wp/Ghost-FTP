...
function bulkDownload(){const paths=[...state.selected];if(paths.length)submitDownload(endpoints.archive,{profile_id:state.profileId,paths:JSON.stringify(paths),name:'byftp-download.zip'});}
