...
var catalogs = map[string]map[string]string{
	"en": {
		...
		"column.name": "Name", "column.type": "Type", "column.size": "Size", "column.modified": "Modified", "column.file": "File", "column.direction": "Direction",
		"column.local": "Local", "column.remote": "Server", "column.status": "Status", "column.progress": "Progress", "column.speed": "Speed", "column.eta": "ETA",
		...
		"settings.load_failed": "Settings could not be loaded; safe defaults are being used.", "settings.title": "Ghost FTP — Settings",
		...
		"about.body":              "Ghost FTP does not track users and does not send entered data to third parties.\nSaved profiles stay on this computer and are protected by Windows.\n\nGhost FTP\n%s\n%s",
		...
		"sftp.security":          "Ghost FTP — SFTP security", "sftp.new_key": "New SFTP server key",
		...
		"connection.connected": "Connected: %s", "disconnect.title": "Ghost FTP — Disconnect", "disconnect.question": "Disconnect and cancel active transfers?",
	...
	"hr": {
		...
		"column.name": "Naziv", "column.type": "Vrsta", "column.size": "Veličina", "column.modified": "Izmijenjeno", "column.file": "Datoteka", "column.direction": "Smjer", "column.local": "Lokalno", "column.remote": "Poslužitelj", "column.status": "Status", "column.progress": "Napredak", "column.speed": "Brzina", "column.eta": "Preostalo", "type.file": "datoteka", "type.folder": "mapa", "type.link": "poveznica", "direction.upload": "Slanje", "direction.download": "Preuzimanje", "status.queued": "Na čekanju", "status.running": "U tijeku", "status.done": "Završeno", "status.failed": "Greška", "status.cancelled": "Otkazano", "status.skipped": "Preskočeno",
