...
<p align="center">
  <img src="docs/assets/screenshots/ghostftp-native-files.png" alt="Ghost FTP native Files workspace — actual Windows RC19 build" width="100%">
</p>
...
<p align="center">
  <img src="docs/assets/screenshots/ghostftp-native-files.png" alt="Ghost FTP Files workspace — actual native app" width="100%">
</p>

### Sites and New Connection

<p align="center">
  <img src="docs/assets/screenshots/ghostftp-native-sites.png" alt="Ghost FTP Sites workspace — actual native app" width="49%">
  <img src="docs/assets/screenshots/ghostftp-native-new-connection.png" alt="Ghost FTP New Connection — actual native app" width="49%">
</p>

### Settings and Transfers

<p align="center">
  <img src="docs/assets/screenshots/ghostftp-native-settings.png" alt="Ghost FTP Settings workspace — actual native app" width="49%">
  <img src="docs/assets/screenshots/ghostftp-native-transfers.png" alt="Ghost FTP Transfers workspace — actual native app" width="49%">
</p>

### File Properties and Help & About

<p align="center">
  <img src="docs/assets/screenshots/ghostftp-native-file-properties.png" alt="Ghost FTP File Properties — actual native app" width="49%">
  <img src="docs/assets/screenshots/ghostftp-native-about.png" alt="Ghost FTP Help and About workspace — actual native app" width="49%">
</p>

These repository screenshots are **1:1 captures of the running native Windows app at 1290×852**. The release QA additionally checks compact and near-minimum layouts, but README imagery intentionally uses the canonical native viewport so controls, spacing and window chrome are shown without scaling the application itself.
