...
- Binary-safe FTP/FTPS transfers plus upload/download queues with pause, resume, retry, cancel and bandwidth controls.
...
- Native Windows and Linux packaging with frameless Tauri window acceptance evidence.
